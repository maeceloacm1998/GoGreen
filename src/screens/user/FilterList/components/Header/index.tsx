...
const checkProps = (props: HeaderProps) => ({
  onClickGoBackListener: props.onClickGoBackListener ? props.onClickGoBackListener : () => {},
  onClickClearListener: props.onClickClearListener ? props.onClickClearListener : () => {}
});
    ...
    <>
      <HeaderContainer>
        <TouchableOpacity style={{ padding: 10 }} onPress={onClickGoBackListener}>
          <Icon name="arrow-back-ios" size={18} color={themes.color.text_color} />
        </TouchableOpacity>
        <Title>Filtrar</Title>
